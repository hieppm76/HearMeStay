        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZaloPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddOnServices_Accommodations_AccommodationId",
                        column: x => x.AccommodationId,
                        principalTable: "Accommodations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsQuietRoom = table.Column<bool>(type: "bit", nullable: false),
                    SupportsVeganMeal = table.Column<bool>(type: "bit", nullable: false),
                    SupportsAllergyRequest = table.Column<bool>(type: "bit", nullable: false),
                    NoStrongScentAvailable = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartnerResponseNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommissionTransactions_Accommodations_AccommodationId",
                        column: x => x.AccommodationId,
                        principalTable: "Accommodations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CommissionTransactions_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasFoodAllergy = table.Column<bool>(type: "bit", nullable: false),
                    FoodAllergyDetail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DietPreference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RoomPreference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HealthNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpecialOccasion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TravelPurpose = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActivityInterest = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NeedAirportPickup = table.Column<bool>(type: "bit", nullable: false),
                    NeedEarlyCheckIn = table.Column<bool>(type: "bit", nullable: false),
                    NeedDecoration = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuestPreferences_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalizationRating = table.Column<int>(type: "int", nullable: false),
                    DidHotelPrepareWell = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GuestPreferenceId = table.Column<int>(type: "int", nullable: false),
                    Summary = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PriorityLevel = table.Column<int>(type: "int", nullable: false),
                    AiJsonResult = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HotelConfirmationMessage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestInsights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuestInsights_GuestPreferences_GuestPreferenceId",
            ...
            migrationBuilder.CreateTable(
                name: "GuestInsightTags",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GuestInsightId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestInsightTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuestInsightTags_GuestInsights_GuestInsightId",
                        column: x => x.GuestInsightId,
                        principalTable: "GuestInsights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuestTasks_GuestInsights_GuestInsightId",
                        column: x => x.GuestInsightId,
                        principalTable: "GuestInsights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UpsellSuggestions_AddOnServices_AddOnServiceId",
                        column: x => x.AddOnServiceId,
                        principalTable: "AddOnServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_UpsellSuggestions_GuestInsights_GuestInsightId",
                        column: x => x.GuestInsightId,
                        principalTable: "GuestInsights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accommodations_Province",
                table: "Accommodations",
                column: "Province");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddOnServices_AccommodationId",
                table: "AddOnServices",
                column: "AccommodationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommissionTransactions_AccommodationId",
                table: "CommissionTransactions",
                column: "AccommodationId");

            migrationBuilder.CreateIndex(
                name: "IX_CommissionTransactions_BookingId",
                table: "CommissionTransactions",
                column: "BookingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GuestInsights_GuestPreferenceId",
                table: "GuestInsights",
                column: "GuestPreferenceId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GuestInsightTags_GuestInsightId",
                table: "GuestInsightTags",
                column: "GuestInsightId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestPreferences_BookingId",
                table: "GuestPreferences",
                column: "BookingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GuestTasks_GuestInsightId",
                table: "GuestTasks",
                column: "GuestInsightId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UpsellSuggestions_AddOnServiceId",
                table: "UpsellSuggestions",
                column: "AddOnServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_UpsellSuggestions_GuestInsightId",
                table: "UpsellSuggestions",
                column: "GuestInsightId");
        }
